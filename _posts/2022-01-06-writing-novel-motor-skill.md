---
title:  "Writing a novel is a motor skill and does not require representations"
---

> Locked-in patients can write novels through eyeblinks...
...
* John Krakauer question: https://www.youtube.com/watch?v=wzAlY4PvbK4&t=1368s
...
Citing Dennett in 1981 in my view does not get rid of the problem
How do you come up with a story ...
without having to invoke mental representations?"

Anderson: neuroscientists use that word
- psychology: science of behavior v. science of the mind
- how do beliefs, desire, intentions
- "he mentioned writing a novel: how does that happen without any representaitons?"
...
Of course, not all writers have the discipline of Natalie Goldberg.
Thus, we have an experiment in nature.
We have a population of writers that exhibit variance in how much they practice the motor skill of writing.
Therefore, if my hypothesis is correct, we should be able to measure 
Obviously this does not rule out that a writer might be surreptitiously using a representation without telling me, although, rude.
But it would be evidence that a major component of writing is the motor skill.