---
title: "Why doesn't scientific software talk about domain modeling?"
description: ""
...
Update 2026-05-30:
I rewrote this again based on a single comment from Juan.
...
I have a question: why doesn't scientific software talk about domain modeling?
That question might immediately make you think that you are not the intended audience 
...
that so many people are currently using to vibe code, 
...
because your all-too-human brain is hardwired to think that anything that can speak a language is as smart as you.

If you're still reading this after that intro paragraph, let me ask again, 
why doesn't scientific software talk about domain modeling?
That question might not make any sense if I don't quickly define *domain model*. 
This is a term of art in computer science and software engineering. 
It can refer to an actual verbal or even mathematical model, 
and so my question might have you saying  
"we already have domain models in science; we just call them *models*, period."
You will also hear the term "domain model" used in the tech community, where programmers go around giving talks,
and where, more often than not, it can sound like it means  
...
as somebody who thinks about research software, 
...
In fact, you might feel like you want to scream that at me.
...
In this post, I will try to convince you that both answers miss the mark in interesting ways. 
...
First, let me introduce domain modeling, and tell you why you might care about it.
...
## OOP as a direct descendent of domain modeling
...
If you read [Elements of Computer], 
...
While the first computers were being built, 
