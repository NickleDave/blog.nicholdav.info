...
but now we've moved from the email to another weird branch on the family tree of computer science: 
HTML and XML.
...
But I'm pretty sure the developers don't think of themselves as "doing DDD". 
In earlier versions of this post, I had a mini-rant about, 
if you feel like everybody already does DDD, then show me! 
...
to look at a big dataset of design docs across time for multiple projects,  
