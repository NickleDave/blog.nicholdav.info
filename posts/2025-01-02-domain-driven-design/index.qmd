...
Update 2025-09-24:
Broke this post up into two posts, one here and [one on the VocalPy developer's blog](https://blog.vocalpy.org/posts/2025-12-19-domain-driven-design/), 
based on feedback from [Ben Fulton](https://fosstodon.org/@benfulton), [Hector Correa](https://hectorcorrea.com/about), 
[Kris Armeni](https://www.kristijanarmeni.net/) and [Warrick Ball])(https://warrickball.gitlab.io/) in [US-RSE](https://us-rse.org/),
and [Felipe Moreno]() in [pyOpenSci]().
